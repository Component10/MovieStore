...
module.exports = function uniteRules(newRule, rule, prepend) {
  ...
  if (newRule.loader) {
    ...
    if (rule.loader) {
      var optionsKey = rule.options ? 'options' : rule.query && 'query';
...
function uniteEntries(newEntry, entry) {
  ...
  var _entry$loader$match2 = _slicedToArray(_entry$loader$match, 1);

  var loaderName = _entry$loader$match2[0];

  var _newEntry$loader$matc = newEntry.loader.match(loaderNameRe);

  var _newEntry$loader$matc2 = _slicedToArray(_newEntry$loader$matc, 1);

  var newLoaderName = _newEntry$loader$matc2[0];
